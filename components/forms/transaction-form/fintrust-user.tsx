            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 hover:bg-white transition-colors duration-200 disabled:bg-gray-100 disabled:cursor-not-allowed text-sm"
                />
                <button
                  type="button"
                  className="px-4 py-3 bg-gray-100 text-gray-700 rounded border border-gray-200 hover:bg-gray-200 disabled:bg-gray-100 disabled:cursor-not-allowed"
                  disabled
                >
                  Verify
                </button>
